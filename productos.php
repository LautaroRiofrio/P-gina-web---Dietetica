<?php
    ...
    $id = $_REQUEST['id'];
    $query = "SELECT * FROM productos WHERE categorias=$id";
...
<body>
    ...
    <h1 class="h1_seccion">Productos</h1>
    <div class="contenedor_grid contenedor_categorias">
        <?php 
        ...
        ?>
                ...
                <div class="tarjeta_producto">
                    ...
                    <div class="precio_producto">$<?php echo $row['precio']; ?></div>
